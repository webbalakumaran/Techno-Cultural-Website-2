...
@import url("https://fonts.googleapis.com/css?family=Lato:400,700|Montserrat:300,500,900|Dosis:500|Kanit");
*, *:before, *:after {
...
<body id="main">
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
          <ul class="list-unstyled">
            ...
            <li>  <?php  if (isset($_SESSION['email'])) : ?>
                    <a href="index.php?logout='1'" style="color:#d6492c; font-size:16px;">Logout</a>
                  <?php endif ?></li>
  ...
  <div  class="menu" >
      <li>
        ...
        <?php else: ?>
            <a href="login.php"><i class="fas fa-sign-in-alt"></i>&nbsp;Login</a><?php endif ?>
          </li>
      <li title="Menu" onclick="openNav()"><i class="fas fa-bars"></i>&nbsp;Menu</li>
  </div>
  	...
  	<div class="main">
  		<center><img class="logo" src="citlogo.png"></center>
  		    ...
  		    <p style="font-family: 'Dosis',sans-serif;font-weight:lighter;font-size: 17px;line-height: 16px;color: #000;">proudly presents</p>
  			<center>
  				<div ><img class="tak" src="taknew logo.png" style=""><img class="takname" src="takname.png"></div></center>
  			<div class="container"> <br>
                    <h1 style="color:#b91010; text-shadow:3px white;"> EVENT STARTED ....!</h1>
                     </div>
                 </div>
